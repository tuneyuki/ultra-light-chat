...
export const MODELS = [
	...
	{ id: 'gemini-3-flash-preview', label: 'Gemini 3 Flash Preview', provider: 'gemini', supportsImage: true, supportsImageGen: false, supportsCodeInterpreter: false, supportsWebSearch: true, reasoningEfforts: ['minimal', 'low', 'medium', 'high'] },
