...
export async function POST({ request }) {
	const { input, chat_id, model, system_prompt, web_search, image_generation, code_interpreter, mcp_servers, messages, reasoning_effort, container_id } = await request.json();
	...
	return handleOpenAI(resolvedModel, input, chat_id, system_prompt, web_search, image_generation, code_interpreter, reasoning_effort, container_id, mcp_servers, userId);
}
